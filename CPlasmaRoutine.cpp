...
CPlasmaRoutine::CPlasmaRoutine()
{
	...
	m_PlasmaColors[0]=RGB(255,255,255);// From black 
	m_PlasmaColors[1]=RGB(39,149,251);// To Blue

	m_PlasmaColors[2]=RGB(39,149,251);// From  Blue
	m_PlasmaColors[3]=RGB(255,255,255);// To Green

	m_PlasmaColors[4]=RGB(255,255,255);// From Green
	m_PlasmaColors[5]=RGB(255,255,255);// To yellow

	m_PlasmaColors[6]=RGB(255,255,255);// From yellow
	m_PlasmaColors[7]=RGB(255,255,255);// to orange

	m_PlasmaColors[8]=RGB(255,255,255);// orange
	m_PlasmaColors[9]=RGB(39,149,251);// red

	m_PlasmaColors[10]=RGB(39,149,251);// From red
	m_PlasmaColors[11]=RGB(255,255,255); // To purple

	m_PlasmaColors[12]=RGB(255,255,255);// From purple
	m_PlasmaColors[13]=RGB(255,255,255);// To dark blue

	m_PlasmaColors[14]=RGB(255,255,255);// From dark blue
	m_PlasmaColors[15]=RGB(255,255,255);// To Black
